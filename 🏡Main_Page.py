...
show_product= True#st.sidebar.checkbox("Show Product Information", value=True)
show_review_graphs = True#st.sidebar.checkbox("Show rating distibutions.", value=True)
show_yearly =True#st.sidebar.checkbox('Show yearly trends in reviews', value=True)
